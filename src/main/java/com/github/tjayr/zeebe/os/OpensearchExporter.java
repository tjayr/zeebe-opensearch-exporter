...
public class OpensearchExporter implements Exporter {
  ...
  public void configure(final Context context) {
    ...
    configuration =
        context.getConfiguration().instantiate(OpensearchExporterConfiguration.class);
  ...
  private void createIndexTemplates() {
    final OpensearchExporterConfiguration.IndexConfiguration index = configuration.index;

...
final class OpensearchExporterFlushTest {
  @Mock private Controller controller;
  @Mock private OpensearchClient client;
  @Mock private Context context;
  private OpensearchExporter exporter;

  @BeforeEach
  void setup() {
    final var esConfig = new OpensearchExporterConfiguration();
    final var exporterConfig = mock(Configuration.class);
    when(exporterConfig.instantiate(eq(OpensearchExporterConfiguration.class)))
        .thenReturn(esConfig);
